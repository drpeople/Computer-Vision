...
###############################################################################
def plot_metrics_vs_angle(df, save_path="ViT_metrics_vs_angle.png"):
...
def main():
    ...
    csv_path = "ViT_rotation_results.csv"  # Updated filename for ViT usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="ViT_metrics_vs_angle.png")

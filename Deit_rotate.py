...
class RotationTransform:
    ...
    Defined at the module level so it's picklable by the DataLoader workers.
    """
...
# Here we use 'deit_base_patch16_224', but you can change to any DeiT variant.
...
###############################################################################
def plot_metrics_vs_angle(df, save_path="DeiT_metrics_vs_angle.png"):
...
def main():
    ...
    for angle in angles:
        ...
        transform_with_rotation = transforms.Compose([
            ...
            transforms.Resize(300),  # Increased size to preserve details after rotation
    ...
    csv_path = "DeiT_rotation_results.csv"  # Updated filename for DeiT usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="DeiT_metrics_vs_angle.png")

...
# Load a pretrained EfficientNet model from torchvision and move it to GPU
...
def main():
    ...
    csv_path = "EfficientNet_rotation_results.csv"
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="EfficientNet_metrics_vs_angle.png")

...
# Use default normalization values from DenseNet121 weights metadata (or fallback to defaults)
...
###############################################################################
def plot_metrics_vs_scale(df, save_path="DenseNet_metrics_vs_scale.png"):
...
def main():
    ...
    for scale_factor in scale_levels:
        ...
        # then resizes and center crops to match the input size expected by DenseNet.
    ...
    csv_path = "DenseNet_scale_results.csv"  # Updated filename for DenseNet usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all scale factors to: {csv_path}")

    plot_metrics_vs_scale(df, save_path="DenseNet_metrics_vs_scale.png")

...
# Import Swin-B weights instead of Swin-T weights
...
###############################################################################
def plot_metrics_vs_blur(df, save_path="SwinB_metrics_vs_blur.png"):
...
def main():
    ...
    csv_path = "SwinB_blur_results.csv"  # Updated filename for Swin-B usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all blur levels to: {csv_path}")
    plot_metrics_vs_blur(df, save_path="SwinB_metrics_vs_blur.png")

...
from torchvision.models import MobileNet_V2_Weights  # Changed from EfficientNet_B0_Weights
...
# Load a pretrained MobileNetV2 model and move it to GPU
...
###############################################################################
def plot_metrics_vs_scale(df, save_path="metrics_vs_scale.png"):
...
def main():
    ...
    for scale_factor in scale_levels:
        ...
        # then resizes and center crops to match the input size expected by MobileNetV2.
    ...
    csv_path = "MobileNetV2_scale_results.csv"  # Updated filename for MobileNetV2 usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all scale factors to: {csv_path}")

    plot_metrics_vs_scale(df, save_path="metrics_vs_scale.png")

...
# Use normalization parameters from the Swin-B weights metadata (or fallback to defaults)
...
###############################################################################
def plot_metrics_vs_angle(df, save_path="SwinB_metrics_vs_angle.png"):
...
def main():
    ...
    csv_path = "SwinB_rotation_results.csv"  # Updated filename for Swin-B usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="SwinB_metrics_vs_angle.png")

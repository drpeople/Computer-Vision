...
###############################################################################
def plot_metrics_vs_angle(df, save_path="MobileNetV3_metrics_vs_angle.png"):
...
def main():
    ...
    csv_path = "MobileNetV3_rotation_results.csv"  # Updated filename to reflect MobileNetV3 usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="MobileNetV3_metrics_vs_angle.png")

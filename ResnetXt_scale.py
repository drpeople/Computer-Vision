...
###############################################################################
def plot_metrics_vs_scale(df, save_path="ResNeXt_metrics_vs_scale.png"):
...
def main():
    ...
    for scale_factor in scale_levels:
        ...
        # then resizes and center crops to match the input size expected by ResNeXt.
    ...
    csv_path = "ResNeXt_scale_results.csv"  # Updated filename for ResNeXt usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all scale factors to: {csv_path}")

    plot_metrics_vs_scale(df, save_path="ResNeXt_metrics_vs_scale.png")

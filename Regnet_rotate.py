...
# Import RegNet weights instead of ConvNeXt Base weights
...
# Use normalization parameters from the RegNet weights metadata (or fallback to defaults)
...
###############################################################################
def plot_metrics_vs_angle(df, save_path="RegNet_metrics_vs_angle.png"):
...
def main():
    ...
    csv_path = "RegNet_rotation_results.csv"  # Updated filename for RegNet usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="RegNet_metrics_vs_angle.png")

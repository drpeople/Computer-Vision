...
# Import ConvNeXt Base weights instead of MobileNet_V2_Weights
...
# Use normalization parameters from the ConvNeXt weights metadata (fallback to defaults)
...
###############################################################################
def plot_metrics_vs_blur(df, save_path="ConvNeXt_metrics_vs_blur.png"):
...
def main():
    ...
    csv_path = "ConvNeXt_blur_results.csv"  # Updated filename for ConvNeXt usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all blur levels to: {csv_path}")

    plot_metrics_vs_blur(df, save_path="ConvNeXt_metrics_vs_blur.png")

...
class GaussianNoiseTransform:
    def __init__(self, noise_std=0.0):
        # noise_std is expected to be in the normalized domain, e.g., 0.0, 0.05, 0.1, etc.
...
###############################################################################
def plot_metrics_vs_noise(df, save_path="SwinB_metrics_vs_noise.png"):
...
def main():
    ...
    csv_path = "SwinB_noise_results.csv"  # Updated filename for Swin-B usage

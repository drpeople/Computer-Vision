...
# Use normalization parameters from the DenseNet121 weights metadata (fallback to defaults)
...
###############################################################################
def plot_metrics_vs_blur(df, save_path="DenseNet_metrics_vs_blur.png"):
...
def main():
    ...
    csv_path = "DenseNet_blur_results.csv"  # Updated filename for DenseNet usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all blur levels to: {csv_path}")

    plot_metrics_vs_blur(df, save_path="DenseNet_metrics_vs_blur.png")

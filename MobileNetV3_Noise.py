...
# Import MobileNetV3 Large weights instead of MobileNetV2 weights
...
class GaussianNoiseTransform:
    def __init__(self, noise_std=0.0):
        # noise_std should now be provided in the normalized domain (e.g., 0.0, 0.05, 0.1, etc.)
        self.noise_std = noise_std

    def __call__(self, img):
        # Convert PIL image to numpy array with type float32 (values in [0, 255])
...
# Load a pretrained MobileNetV3 Large model from torchvision and move it to GPU
...
def main():
    ...
    csv_path = "MobileNetV3_noise_results.csv"  # Updated filename to reflect MobileNetV3 usage

...
class GaussianNoiseTransform:
    def __init__(self, noise_std=0.0):
        # noise_std should be provided in the normalized domain (e.g., 0.0, 0.05, etc.)
        self.noise_std = noise_std

    def __call__(self, img):
        # Convert PIL image to a numpy array of type float32 and scale to [0, 1]
...
# Load a pretrained RegNet_Y_400MF model using its recommended weights and move it to GPU
...
###############################################################################
def plot_metrics_vs_noise(df, save_path="RegNet_metrics_vs_noise.png"):
    ...
    plt.title("Model Performance vs. Noise Standard Deviation (RegNet)")
...
def main():
    ...
    csv_path = "RegNet_noise_results.csv"  # Updated filename to reflect RegNet usage

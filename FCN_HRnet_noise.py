...
from torchvision.models.segmentation import FCN_ResNet50_Weights  # <- Changed import
import numpy as np
...
def run_inference(dataset, batch_size=8):
    ...
    for images, masks, _ in loader:
        ...
        with torch.cuda.amp.autocast():
            # For FCN, the main segmentation output is still ['out']
...
def main():
    ...
    # Updated CSV filename to reflect FCN instead of DeepLab
    csv_path = "fcn_resnet50_noise_results.csv"

...
# Load a pretrained EfficientNet-B0 model and move it to GPU
...
def main():
    ...
    for scale_factor in scale_levels:
        ...
        # then resizes and center crops to match the input size expected by EfficientNet-B0.
    ...
    csv_path = "EfficientNet_scale_results.csv"

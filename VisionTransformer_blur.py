...
# Use normalization parameters from the ViT‑B‑16 weights metadata (or fallback to defaults)
...
###############################################################################
def plot_metrics_vs_blur(df, save_path="ViT_metrics_vs_blur.png"):
...
def main():
    ...
    for blur_radius in blur_levels:
        ...
        print(f"\n--- Metrics for blur_radius={blur_radius:.2f} ---")
    ...
    csv_path = "ViT_blur_results.csv"  # Updated filename for ViT usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all blur levels to: {csv_path}")
    plot_metrics_vs_blur(df, save_path="ViT_metrics_vs_blur.png")

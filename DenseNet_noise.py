...
# Import DenseNet121 weights instead of ConvNeXt Base weights
...
class GaussianNoiseTransform:
    ...
    def __call__(self, img):
        # Convert the PIL image to a float32 NumPy array and scale to [0, 1]
        np_img = np.array(img, dtype=np.float32) / 255.0
        # Generate Gaussian noise (mean 0) in the normalized domain
...
###############################################################################
def plot_metrics_vs_noise(df, save_path="DenseNet_metrics_vs_noise.png"):
...
###############################################################################
def main():
    # Update noise levels to normalized values instead of pixel values
    ...
    csv_path = "DenseNet_noise_results.csv"  # Updated filename for DenseNet usage

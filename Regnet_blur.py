...
# Import RegNet_Y_400MF weights instead of ConvNeXt Base weights
...
# Use normalization parameters from the RegNet weights metadata (fallback to defaults)
...
###############################################################################
def plot_metrics_vs_blur(df, save_path="RegNet_metrics_vs_blur.png"):
...
def main():
    ...
    csv_path = "RegNet_blur_results.csv"  # Updated filename for RegNet usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all blur levels to: {csv_path}")

    plot_metrics_vs_blur(df, save_path="RegNet_metrics_vs_blur.png")

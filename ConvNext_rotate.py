...
# Use normalization parameters from the ConvNeXt weights metadata (or fallback to defaults)
...
###############################################################################
def plot_metrics_vs_angle(df, save_path="ConvNeXt_metrics_vs_angle.png"):
...
def main():
    ...
    csv_path = "ConvNeXt_rotation_results.csv"  # Updated filename for ConvNeXt usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all rotation angles to: {csv_path}")

    plot_metrics_vs_angle(df, save_path="ConvNeXt_metrics_vs_angle.png")

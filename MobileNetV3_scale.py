...
# Import MobileNetV3 Large weights instead of MobileNet_V2_Weights
...
# Load a pretrained MobileNetV3 Large model and move it to GPU
...
###############################################################################
def plot_metrics_vs_scale(df, save_path="MobileNetV3_metrics_vs_scale.png"):
...
def main():
    ...
    for scale_factor in scale_levels:
        ...
        # then resizes and center crops to match the input size expected by MobileNetV3.
    ...
    csv_path = "MobileNetV3_scale_results.csv"  # Updated filename for MobileNetV3 usage
    df.to_csv(csv_path, index=False)
    print(f"Saved metrics for all scale factors to: {csv_path}")

    plot_metrics_vs_scale(df, save_path="MobileNetV3_metrics_vs_scale.png")

...
from torchvision.models.segmentation import FCN_ResNet50_Weights  # <-- CHANGED
import numpy as np
...
# CHANGED: Load FCN instead of DeepLabV3
...
def plot_blur_sweep(blur_levels, pixel_accs, mious):
    ...
    plt.title("Segmentation Results vs. Gaussian Blur Sigma (FCN)")
...
def main():
    ...
    csv_path = "fcn_blur_results.csv"  # <-- CHANGED (optional)
